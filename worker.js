...
const HTML = [
  ...
  '        container.innerHTML = \'<div class="music-player"><img class="music-cover" id="musicCover" style="display:none;"><div class="music-info"><div class="music-title" id="musicTitle">\' + item.name + \'</div><div class="music-artist" id="musicArtist"></div><div class="music-album" id="musicAlbum"></div></div><audio controls src="/api/download?fileId=\' + item.id + \'" id="musicAudio"><div class="lyrics-container" id="lyricsContainer" style="display:none;"></div></div>\';',
